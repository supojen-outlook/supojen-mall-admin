...
import { useBrandsCascader } from './useBrandsCascader.ts'
...
// 從 useBrandsCascader 組合式函數中獲取狀態和方法
const { loading, cascaderProps: baseCascaderProps, getPath } = useBrandsCascader(props.leafOnly)
...
const cascaderProps = computed(() => ({
  ...baseCascaderProps.value,  // 從 useBrandsCascader 獲取的基礎屬性
